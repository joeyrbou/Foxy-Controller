...
A phone-first controller for a cosplay suit. Open `index.html` in a browser to use the visual demo. All six soundboard buttons play the included recordings.
